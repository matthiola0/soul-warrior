...
export default class Knight extends cc.Component {
    ...
    private fDown: boolean = false;          // attack
    private spaceDown: boolean = false;          // shoot
    ...
    start () {
        ...
        clickEventHandler.component = "pvp_player1";
    ...
    update (dt) {
        ...
        if (this.soul_attack != 0) {
            if (this.spaceDown && this.canShoot && this.soul > this.attack_consume) {
        ...
        cc.find("Canvas/Main Camera/soul_num_player1").getComponent(cc.Label).string = String(this.soul);
        ...
        if(this.node.y <= -400){
            if(this.soul > 1){
                ...
                enterBtnEvent.component = "pvp_player1";
    ...
    private playerAnimation()
    {
        ...
        this.node.scaleX = (this.aDown) ? 1 : (this.dDown) ? -1 : this.node.scaleX;
            ...
            else if(this.fDown && !this.anim.getAnimationState('knight_attack_ingame').isPlaying){
